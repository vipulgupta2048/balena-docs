...
If you are powering your USB modem from a Raspberry Pi, it is a good idea to enable the [full 1.2A current](https://docs.balena.io/learn/develop/hardware/i2c-and-spi/#increase-usb-current-throughput) throughput for the USB ports.
