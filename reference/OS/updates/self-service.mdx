...
To run an update for an individual device, navigate to that device's *Settings* tab, go to the section *OS version*, and select the version of balenaOS you would like to update to. After making your selection, click the *Save* button.
<Frame>
...
<Frame>
[![Device group update](https://docs.balena.io/img/common/updates/group-update.webp)](https://docs.balena.io/img/common/updates/group-update.webp)
</Frame>
...
<Frame>
[![device group update, dialog box](https://docs.balena.io/img/common/updates/group-update-dialog.webp)](https://docs.balena.io/img/common/updates/group-update-dialog.webp)
</Frame>
<Note>
**Note:**

Updates to the balena Supervisor, balena's agent on the device, can be [triggered independently](https://docs.balena.io/reference/supervisor/supervisor-upgrades).
</Note>
...
Check out our [update process](https://docs.balena.io/updates/update-process/) to understand how the process goes through each step.
