...
<Frame>[![Modify menu highlighting Pin to release](https://docs.balena.io/img/common/release-policy/devices_table_modify.webp)](https://docs.balena.io/img/common/release-policy/devices_table_modify.webp)</Frame>
...
<Frame>[![Pencil icon to edit target release](https://docs.balena.io/img/common/release-policy/device_target_release_pencil.webp)](https://docs.balena.io/img/common/release-policy/device_target_release_pencil.webp)</Frame>
- Lastly, the Settings page of a device also has the option to pin the release.
<Frame>[![Device settings page with pin to release dropdown](https://docs.balena.io/img/common/release-policy/device_settings.webp)](https://docs.balena.io/img/common/release-policy/device_settings.webp)</Frame>
