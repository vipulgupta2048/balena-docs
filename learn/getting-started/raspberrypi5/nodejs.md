...
Once you've completed this getting started guide to balena, you'll be equipped with the fundamentals needed to continue developing your application using balenaCloud and be on the path to deploying fleets of devices to production. If you are looking for definitions of certain terms, refer to the [glossary](https://docs.balena.io/learn/more/glossary/).

## What you'll need

- Your Raspberry Pi 5 device you want to get started with. Check out all of our [supported devices](https://docs.balena.io/reference/hardware/devices/).
...
A fleet is a group of devices that share the same [architecture](https://docs.balena.io/reference/hardware/devices/) and run the same code. Devices are added to fleets and can be moved between fleets at any time.
...
Enter a fleet name, select the **Raspberry Pi 5** device type, choose the *Starter* [fleet type](https://docs.balena.io/learn/accounts/fleet-types), and click **Create new fleet**:
<Frame>
[![Fleet creation dialog](https://docs.balena.io/img/getting-started/create-fleet.webp)](https://docs.balena.io/img/getting-started/create-fleet.webp)
</Frame>
...
<Frame>
[![Add a device](https://docs.balena.io/img/getting-started/fleet-view.webp)](https://docs.balena.io/img/getting-started/fleet-view.webp)
</Frame>
balenaCloud builds a custom balenaOS image configured for Raspberry Pi 5 which allows the device to provision and join the new fleet you created automatically. Start by clicking **Add device** on the fleet summary. Your device type will be preselected here since you already chose it when creating the fleet. Other device types of the same [architecture](https://docs.balena.io/reference/hardware/devices/) can also be picked to join the fleet.
<Frame>
...
Select an OS type of *balenaOS*, and you will see a list of available balenaOS versions with the latest preselected. Choose a **Development** version of the OS. The production OS does not facilitate the development workflow we'll be using. Find out more about the [differences between Development and Production images](https://docs.balena.io/understanding/understanding-devices/2.0.0/#development-vs-production-images).
<Frame>
[![Network configuration](https://docs.balena.io/img/common/app/network.webp)](https://docs.balena.io/img/common/app/network.webp)
</Frame>
...
<Frame>
[![Download Image](https://docs.balena.io/img/common/app/download_image.webp)](https://docs.balena.io/img/common/app/download_image.webp)
</Frame>
...
When complete, after a minute or two the device should appear on your balenaCloud [dashboard](https://dashboard.balena-cloud.com/), and you should now be ready to deploy some code. If you are not able get the device to appear on the dashboard, then check out our [troubleshooting guide for Raspberry Pi 5](https://docs.balena.io/faq/troubleshooting/raspberrypi5) or try our [support channels](https://docs.balena.io/support/).
...
<Steps>
  <Step>
   [Download the CLI installer](https://github.com/balena-io/balena-cli/releases/download/v22.2.4/balena-cli-v22.2.4-macOS-x64-installer.pkg).
  </Step>
  <Step>
...
<Steps>
  <Step>
   [Download the CLI installer](https://github.com/balena-io/balena-cli/releases/download/v22.2.4/balena-cli-v22.2.4-windows-x64-installer.exe).
  </Step>
  <Step>
 Double click the downloaded file to run the installer and follow the installer's instructions.
 </Step>
...
<Steps>
  <Step>
   [Download the standalone CLI](https://github.com/balena-io/balena-cli/releases/download/v22.2.4/balena-cli-v22.2.4-linux-x64-standalone.tar.gz).
  </Step>
  <Step>
Extract the contents of the tar.gz file to any folder you choose, for example `/home/james`. The extracted contents will include a `balena/bin` folder.
  </Step>
  <Step>
   Add that folder (e.g. `/home/james/balena/bin`) to the PATH environment variable. Check this [StackOverflow](https://stackoverflow.com/questions/14637979/how-to-permanently-set-path-on-linux-unix) post for instructions. Close and re-open the terminal window so that the changes to PATH can take effect.
  </Step>
</Steps>
...
<Frame>
[![Web authorization](https://docs.balena.io/img/common/cli/web_authorization.webp)](https://docs.balena.io/img/common/cli/web_authorization.webp)
</Frame>
## Create a release
...
<Frame>
[![Service download progress](https://docs.balena.io/img/common/device/download-progress.webp)](https://docs.balena.io/img/common/device/download-progress.webp)
</Frame>
...
<Frame>
[![Enable public URLs](https://docs.balena.io/img/common/device/enable-public-url-device.webp)](https://docs.balena.io/img/common/device/enable-public-url-device.webp)
</Frame>
...
<Frame>
[![Success screen 1](https://docs.balena.io/img/getting-started/success.webp)](https://docs.balena.io/img/getting-started/success.webp)
</Frame>
...
<Frame>
[![Local IP address](https://docs.balena.io/img/getting-started/local-ip-address.webp)](https://docs.balena.io/img/getting-started/local-ip-address.webp)
</Frame>
```bash
...
<Frame>
[![Success screen 2](https://docs.balena.io/img/getting-started/success-change.webp)](https://docs.balena.io/img/getting-started/success-change.webp)
</Frame>
## Next steps
...
- Learn more about [local mode](https://docs.balena.io/learn/develop/local-mode), which allows you to build and sync code to your device locally for rapid development.
- Develop an application with [multiple containers](https://docs.balena.io/learn/develop/multicontainer) to provide a more modular approach to fleet management.
- Manage your device fleet with the use of [configuration](https://docs.balena.io/learn/manage/configuration/), [environment](https://docs.balena.io/learn/manage/variables/), and [service variables](https://docs.balena.io/learn/manage/variables/).
- Find out more about the [balena CLI](https://docs.balena.io/reference/cli/) and the functionality it offers.
- Visit our blog to find step-by-step tutorials for some [classic balena projects](https://balena.io/blog/tags/project/).
